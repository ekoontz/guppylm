...
# 2. shuffle(samples).
# 3. split into two sets: eval_samples and train_samples, where eval is 5% and train is the remaining 95% of the samples.
# 4. write the sets into the 4 files mentioned above.

# A sample is what's generated by one of the no-argument functions in the topics[] array:
# and is a map of
# - input: an example of something a user would say to the chat prompt
# - output: an example of what the Guppy AI should reply with to that input
# - category: the category proper to that topic
#
# For example, the function gen_food() might return the following map:
#
# {
#  'input': 'feeding time',
#  'output': "yes. always yes. i've been investigating a speck waiting for this moment. please.",
#  'category': 'food'}
# }
#
